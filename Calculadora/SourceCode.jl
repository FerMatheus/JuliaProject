...
signal_connect(write_label, bt1, "clicked")
signal_connect(write_label, bt2, "clicked")
signal_connect(write_label, bt3, "clicked")
signal_connect(write_label, bt4, "clicked")
signal_connect(write_label, bt5, "clicked")
signal_connect(write_label, bt6, "clicked")
signal_connect(write_label, bt7, "clicked")
signal_connect(write_label, bt8, "clicked")
signal_connect(write_label, bt9, "clicked")
signal_connect(write_label, bt0, "clicked")
signal_connect(write_label, btplus, "clicked")
signal_connect(write_label, btminus, "clicked")
signal_connect(write_label, btmulti, "clicked")
signal_connect(write_label, btdiv, "clicked")
signal_connect(write_label, btC, "clicked")
signal_connect(write_label, btequals, "clicked")
signal_connect(write_label, btpi, "clicked")
signal_connect(write_label, bteuler, "clicked")
signal_connect(write_label, btcos, "clicked")
signal_connect(write_label, btsen, "clicked")
signal_connect(write_label, btfat, "clicked")
signal_connect(write_label, btsquare, "clicked")
signal_connect(write_label, btoneAboveX, "clicked")
signal_connect(write_label, btmoduler, "clicked")
signal_connect(write_label, btsquareRoot, "clicked")
signal_connect(write_label, btmod, "clicked")
signal_connect(write_label, btln, "clicked")
signal_connect(write_label, btlog, "clicked")
signal_connect(write_label, btinv, "clicked")
signal_connect(write_label, btdot, "clicked")
signal_connect(write_label, btspace, "clicked")
